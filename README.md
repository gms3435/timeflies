...
4. **🌱 ESG Flies (Sustentabilidade & Desperdício Zero):** Registro diário simplificado de práticas ecológicas, monitoramento de consumo de água, cálculo de CO₂, **Lista de Compras inteligente** dividida por categorias e controle de **Validade de Alimentos Frescos (Desperdício Zero)** com status visual cromático (semáforo) de vencimento e integração direta (envio rápido de alimentos comprados para a validade com 1 clique).
...
6. **💪 Body Flies (Saúde Física & Ficha de Academia):** Copos d'água interativos de 250ml para hidratação, qualidade e média de sono, peso, **Ficha de Treino interativa (A/B/C)** pré-configurada e totalmente editável, com controle de séries, repetições, carga (Kg) inline, registro de frequência semanal de atividades físicas e **Timer de Descanso visual** integrado na ficha (sem som).
